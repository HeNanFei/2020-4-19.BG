...
public interface UserInter {
    ...
    public void addUser(@ApiParam("用户实体") SysUser2 user);

    @ApiOperation(value = "修改用户")
    @RequestMapping("/user/update/")
    public void updateUser(@ApiParam("用户实体") SysUser2 user);
    ...
    public SysUser2 getUserById(@PathVariable Integer id);

    @ApiOperation(value = "根据姓名查询用户")
    @ResponseBody
    @RequestMapping("/user/find/name/{username}")
    public SysUser2 getUserByName(@PathVariable String username);
